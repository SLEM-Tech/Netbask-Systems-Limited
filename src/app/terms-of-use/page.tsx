...
const Page = () => {
  ...
  return (
    <AppLayout>
      <main className="bg-white mx-auto pb-24">
            ...
            <div id="termsOfUse" className="text-gray-600 space-y-6">
              <div>
                ...
                <p className="mt-3 leading-[1.8] text-xs md:text-sm xl:text-base">
                  By accessing the Netbask Systems Limited platform and
              ...
              <ul className="list-none space-y-5 text-xs md:text-sm xl:text-base">
                <li>
                  ...
                  Netbask Systems Limited operates on a two-phase payment model.{" "}
                ...
                <li>
                  ...
                  7-14 days; Sea: 45-60 days) are estimates. Netbask Systems
                  Limited is not liable for delays caused by international
                ...
                <li>
                  ...
                  market volatility. Netbask Systems Limited reserves the right
                  to adjust invoices if there is a significant shift in the
                ...
                <li>
                  ...
                  list. Netbask Systems Limited reserves the right to cancel
              ...
              <div className="bg-slate-50 p-4 rounded-2xl border border-slate-100 mt-6">
                <p className="leading-[1.6] text-xs md:text-sm italic">
                  ...
                  Netbask Systems Limited acts as a procurement and logistics
          ...
          {activeTab === "privacyPolicy" && (
            <div id="privacyPolicy" className="text-slate-600 space-y-8">
              ...
              <div>
                ...
                <p className="mt-3 leading-[1.8] text-xs md:text-sm xl:text-base">
                  Netbask Systems Limited collects personal information to
                ...
                <ul className="mt-4 space-y-3 text-xs md:text-sm xl:text-base list-none pl-0">
                  ...
                  <li className="flex items-start gap-3">
                    ...
                    <span>
                      ...
                      protect the Netbask Systems Limited ecosystem.
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="mt-1.5 size-1.5 rounded-full bg-primary-100 shrink-0" />
              ...
              <div className="bg-slate-900 text-white p-8 rounded-[2.5rem] shadow-xl relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <p className="mt-4 leading-[1.8] text-xs md:text-sm xl:text-base opacity-80">
                    Netbask Systems Limited employs bank-grade AES-256
              ...
              <div>
                ...
                <p className="mt-2 leading-[1.8] text-xs md:text-sm xl:text-base">
                  ...
                  <a
                    href="mailto:support@netbask.com"
